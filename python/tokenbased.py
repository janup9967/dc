...
# output
'''
Enter the number of sites: 5
Enter the site ID which initially has the token (1-5): 1
Site 1 has the token.
Site 1 executes critical section.
Site 1 retains the token.
Enter the site ID that wants to enter the critical section (1-5): 5
Token sent from Site 1 to Site 5
Site 5 has the token.
Site 5 executes critical section.
Site 5 retains the token.
Enter the site ID that wants to enter the critical section (1-5): 3
Token sent from Site 5 to Site 3
Site 3 has the token.
Site 3 executes critical section.
Token sent from Site 3 to Site 5
Enter the site ID that wants to enter the critical section (1-5): 1
Token sent from Site 5 to Site 1
Site 1 has the token.
Site 1 executes critical section.
Token sent from Site 1 to Site 3
'''
